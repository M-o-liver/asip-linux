...
if active.stdout.strip() != "active":
    gates.append("unsafe_final_state")
    findings.append({"code": "service_not_active", "message": "fixture service is not active"})
...
if not isinstance(evidence, dict):
    ...
    # Historical failed attempts that were later retried are not unresolved.
...
print(json.dumps({
    ...
    "evidence": [
        {"kind": "fixture_state", "result": "pass" if not [g for g in gates if g == "unsafe_final_state"] else "fail"},
